...
<s:form action="addNewModelAction" namespace="/" theme="css_xhtml" method="POST" enctype="multipart/form-data"
		id="addNewModelFormId" validate="true" name="addNewModelForm">
	...
	<li>
		<table cellpadding="1px" cellspacing="1px" width="100%">
			...
			<tr>
				...
				<td>
					<s:select list="#{-1:'First Select the Device Type...'}" name="manufacturerId" id="manufacturerId" cssStyle="width:222px;"/>
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center">
<!--					<s:submit name="fetchModelBtn" id="fetchModelBtnId" value="Fetch Models" method="fetchModels" theme="simple"/>-->
					<s:submit name="addModelBtn" id="addModelBtnId" value="Add New Model" method="openAddNewModelBlock"  theme="simple" disabled="true" cssClass="button"/>
				</td>
			</tr>
		</table>
	</li>
...
<s:if test="%{addNewModel}">
<h3>Add New Model : <s:property value="%{manufacturerName}"/> </h3>
<ul>
	<li><s:actionerror /><s:fielderror></s:fielderror> <s:actionmessage /></li>
	<li>
		...
		<table cellpadding="2px" cellspacing="2px" width="100%">
			<tr>
				...
				<td>
					<s:textfield name="modelName" id="modelNameId" size="70" maxlength="500" onblur="trimTextField(this);"/>
				</td>
				<td rowspan="3">
			...
			<tr>
				...
				<td>
					<s:textfield name="modelLaunchDate" id="datePicker" size="20" maxlength="12"  onblur="trimTextField(this);"></s:textfield>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<s:textfield name="price" id="price" size="20" maxlength="5" onblur="trimTextField(this);"></s:textfield>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<s:textarea name="modelDesc" id="modelDescId" cols="62" rows="10" onblur="trimTextField(this);"></s:textarea>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<s:textfield name="modelImageUrl" id="modelImageUrlId" size="110" onblur="previewModelImage(this)"></s:textfield>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td colspan="3" align="center">
					...
					<s:submit name="submitBtn" method="addNewModel" id="submitBtnId" value="Submit" align="center" theme="simple" cssClass="button"/>
				</td>
			</tr>
		</table>
		</li>
