...
public class CategoryModelsStoredProcedure extends StoredProcedure {
    
    public CategoryModelsStoredProcedure(DataSource dataSource, String sprocName) {
        ...
        declareParameter(new SqlParameter(ZProcConstants.IN_MODEL_CATEGORY_ID,Types.BIGINT));
        compile();
    }

	@SuppressWarnings("unchecked")
	public Map execute(Long deviceId,Long categoryId) {
		Map inputs=new HashMap();
        inputs.put(ZProcConstants.IN_DEVICE_ID, deviceId);
        inputs.put(ZProcConstants.IN_MODEL_CATEGORY_ID, categoryId);
