...
public class MoreCategoryModelsStoredProcedure extends StoredProcedure {
    
    public MoreCategoryModelsStoredProcedure(DataSource dataSource, String sprocName) {
	...
	public Map execute(Long deviceId,Long manufacturerId, String galleryType, Integer pageSize,Integer pageNo) {
        ...
        inputs.put(ZProcConstants.IN_MODEL_CATEGORY_ID, manufacturerId);
