...
public class OpenIdAuthenticator {
	...
	private static Logger logger=LogManager.getLogger(OpenIdAuthenticator.class);
    ...
    private static ConsumerManager getConsumerManager(Map<String, Object> application) {
        ...
        if (manager == null) {
            ...
            try {
            	...
            	logger.error("Error in ConsumerManager", e);
            }
    ...
    public static UserDto getAuthenticatedUser(Map<String,String[]> parmList,
        ...
        if (authSuccess.hasExtension(AxMessage.OPENID_NS_AX)) {
            ...
            user.setUserEmail(fetchResp.getAttributeValue("email"));
            user.setUserName(fetchResp.getAttributeValue("fullname"));
            if(StringUtility.isNullBlank(user.getUserName()))
            	user.setUserName(fetchResp.getAttributeValue("first")+" "+fetchResp.getAttributeValue("last"));
            ...
            logger.info("User: " + CommonUtility.getDTOasXML(user));
        }
        ...
        if (authSuccess.hasExtension(SRegMessage.OPENID_NS_SREG)) {
            ...
            if (StringUtils.isBlank(user.getUserEmail())) {
                user.setUserEmail(sregResp.getAttributeValue("email"));
            }
        }
        return user;
    }
